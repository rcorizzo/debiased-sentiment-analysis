...
# ________________________________
# Use RF and SVM to test and compute metrics
# ________________________________

svm_preds = clf.predict(features_testing)
print(svm_preds)

# Save Predictions:
comments_testing["predicted_stars_SVM_balanced"] = svm_preds
comments_testing.to_csv("../../output/comments_equal_sample_equal_stars_3000_classified_SVM_model_balanced_40000.csv", index=False)